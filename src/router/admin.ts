...
adminRouter.post("/hiring-calender",authMiddleware,adminMiddleware,postHiringCalender)
adminRouter.get("/hiring-calender",authMiddleware,getHiringCalender)
adminRouter.put("hiring-calender",authMiddleware,adminMiddleware,updateHiringcalender)
